...
- [template_registry.py](../src/project_runtime/template_registry.py)
- [project_governance.py](../src/project_runtime/project_governance.py)
- [materialize_project.py](../scripts/materialize_project.py)
...
仍然主要在 [knowledge_base.py](../src/project_runtime/knowledge_base.py)：
...
- [workspace_governance.py](../src/workspace_governance.py)
...
入口是 [project_governance.py](../src/project_runtime/project_governance.py) 的：
...
入口是 [knowledge_base.py](../src/project_runtime/knowledge_base.py)：
...
核心是 [knowledge_base.py](../src/project_runtime/knowledge_base.py) 的 `_compile_project()`。
...
- [app.py](../src/knowledge_base_runtime/app.py) 的 `build_knowledge_base_runtime_app()`
- [backend.py](../src/knowledge_base_runtime/backend.py) 的 `build_knowledge_base_router()`
...
入口是 [knowledge_base.py](../src/project_runtime/knowledge_base.py) 的：
...
入口是 [governance.py](../src/project_runtime/governance.py)：
...
- [frontend_style.py](../src/knowledge_base_runtime/frontend_style.py)
- [frontend_script.py](../src/knowledge_base_runtime/frontend_script.py)
